    ...
    internal class Queen :Piece
    {
        ...
        public override List<Move> GetPotentialMoves(Board board, bool includeCastling = true)
        {
            ...
            while (canContinue)
            {
                ...
                if (currPos.Row < 0 || currPos.Row > 7 || currPos.Col < 0 || currPos.Col > 7) { canContinue = false; continue; }
                ...
                if (!currPos.Equals(BoardPosition) && !isOwnPiece)
                {
                    ...
                    if (pieceOnCell != null) move.SetCapture(pieceOnCell);
                    moves.Add(move);
                }
                if (pieceOnCell != null) canContinue = false;
            }
