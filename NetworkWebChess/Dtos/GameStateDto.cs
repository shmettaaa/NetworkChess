...
namespace NetworkWebChess.Dtos
{
    public class GameStateDto
    {
        ...
        public GameStateDto(Guid gameId, string fen, string message, PieceColor currentPlayer,
                            bool isGameOver, string? gameResult, bool canKingside, bool canQueenside)
        {
            GameId = gameId;
            Fen = fen;
            Message = message;
